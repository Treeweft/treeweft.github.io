...
- Dark: `assets/branding/treeweft-logo-horizontal.svg`
- Light: `assets/branding/treeweft-logo-horizontal-light.svg`

### Stacked Lockup

Mark above wordmark. Use in square spaces: app icons, avatars, profile photos.

- `assets/branding/treeweft-logo-stacked.svg`

### Mark Only

Standalone symbol. Use for favicons, app icons, social avatars.

- `assets/branding/treeweft-mark.svg`
- Favicon: `assets/branding/treeweft-favicon.svg` (32x32, dark bg, rounded)
